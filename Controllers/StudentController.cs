...
namespace School.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,name,date_of_birth,ClassesId,CountriesId,created_date,modified_date")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,name,date_of_birth,ClassesId,CountriesId,created_date,modified_date")] Student student)
        {
            if (id != student.id)
            {
                return NotFound();
